...
// this method proves true if a tarp is needed and false if not. 
  ...
  public static int countFlashlights(int numCampers){
    ...
    for (int i=numCampers;i>=1;i=i-4){
       numFlashlights++;
  ...
  public static boolean checkTents(int numSmall, int numBig, int numCampers){
    ...
    if(numCampers<=(4*numBig)+(numSmall)&&(numCampers%4=0)){
return true;
    }
  ...
  System.out.println(checkTents(2, 5, 20));
  System.out.println(pairSocks(5));
  System.out.println(pairSocks(222));
  System.out.println(checkTarp(true, false));
  System.out.println(checkTarp(true, true));
  System.out.println(checkTarp(false, false));
  System.out.println(checkTarp(false, true));

  System.out.println(checkBoots(5,6));
  System.out.println(checkBearBag(16,true));
  System.out.println(checkBearBag(17,false));
  System.out.println(countFlashlights(24));
  System.out.println(checkTable(true, true));
  System.out.println(checkTable(true, false));
